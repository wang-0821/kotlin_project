package xiao.boot.mybatis.database
...
import xiao.boot.mybatis.testing.KtTestXMLLanguageDriver
...
abstract class BaseDatabase(
    ...
    init {
        javaClass.getAnnotation(xiao.boot.mybatis.annotation.KtSpringDatabase::class.java)
            .let {
                name = it.name
