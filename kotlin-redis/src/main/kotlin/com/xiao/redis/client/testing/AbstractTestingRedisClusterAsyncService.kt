 ...
 * @author lix wang
 */
abstract class AbstractTestingRedisClusterAsyncService : RedisClusterAsyncService {
    ...
    override fun getConnection(nodeId: String?): RedisClusterAsyncCommands<String, String> {
        throw UnsupportedOperationException()
    }

    override fun getConnection(host: String?, port: Int): RedisClusterAsyncCommands<String, String> {
        throw UnsupportedOperationException()
    }

    override fun getStatefulConnection(): StatefulRedisClusterConnection<String, String> {
        throw UnsupportedOperationException()
    }

    override fun readonly(predicate: Predicate<RedisClusterNode>?): AsyncNodeSelection<String, String> {
        throw UnsupportedOperationException()
    }

    override fun nodes(predicate: Predicate<RedisClusterNode>?): AsyncNodeSelection<String, String> {
        throw UnsupportedOperationException()
    }

    override fun nodes(predicate: Predicate<RedisClusterNode>?, dynamic: Boolean): AsyncNodeSelection<String, String> {
        throw UnsupportedOperationException()
    }
}