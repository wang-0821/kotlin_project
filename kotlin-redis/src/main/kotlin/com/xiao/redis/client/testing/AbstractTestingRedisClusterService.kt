 ...
 * @author lix wang
 */
abstract class AbstractTestingRedisClusterService : RedisClusterService {
    ...
    override fun getConnection(nodeId: String?): RedisClusterCommands<String, String> {
        throw UnsupportedOperationException()
    }

    override fun getConnection(host: String?, port: Int): RedisClusterCommands<String, String> {
        throw UnsupportedOperationException()
    }
    ...
    override fun readonly(predicate: Predicate<RedisClusterNode>?): NodeSelection<String, String> {
        throw UnsupportedOperationException()
    }

    override fun nodes(predicate: Predicate<RedisClusterNode>?): NodeSelection<String, String> {
        throw UnsupportedOperationException()
    }

    override fun nodes(predicate: Predicate<RedisClusterNode>?, dynamic: Boolean): NodeSelection<String, String> {
        throw UnsupportedOperationException()
    }
}